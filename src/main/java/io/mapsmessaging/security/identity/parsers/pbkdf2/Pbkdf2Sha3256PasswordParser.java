...
public class Pbkdf2Sha3256PasswordParser extends Pbkdf2Sha3PasswordParser {

  private static final int HASH_BYTE_SIZE = 32;
  private static final String PBKDF2_ALGORITHM = "PBKDF2WithHmacSHA3-256";
  private static final int PBKDF2_ITERATIONS = 10000;

  public Pbkdf2Sha3256PasswordParser() {
    super("");
  }

  public Pbkdf2Sha3256PasswordParser(String password) {
    super(password);
  }
  ...
  public PasswordParser create(String password) {
    return new Pbkdf2Sha3256PasswordParser(password);
  }
