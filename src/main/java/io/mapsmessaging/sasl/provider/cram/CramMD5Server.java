 ...
 * @author Rosanna Lee
 */
public final class CramMD5Server extends CramMD5Base implements SaslServer {
   ...
   */
  public CramMD5Server(String protocol, String serverFqdn, Map<String, ?> props,
  ...
  public byte[] evaluateResponse(byte[] responseData)
    ...
    try {
      if (challengeData == null) {
        ...
        challengeData = challengeStr.getBytes(StandardCharsets.UTF_8);
        ...
        String username = new String(responseData, 0, ulen, StandardCharsets.UTF_8);
        ...
        pw = pwStr.getBytes(StandardCharsets.UTF_8);
        ...
        byte [] expectedDigest = digest.getBytes(StandardCharsets.UTF_8);
