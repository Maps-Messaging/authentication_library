 ...
 * @author Rosanna Lee
 */
public final class DigestMD5Client extends DigestMD5Base implements SaslClient {
   ...
   */
  public DigestMD5Client(String authzid, String protocol, String serverName,
    ...
    if (authzid != null) {
      ...
      authzidBytes = authzid.getBytes(StandardCharsets.UTF_8);
